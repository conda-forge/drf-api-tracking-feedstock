...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/drf-api-tracking-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12540&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/drf-api-tracking-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `drf-api-tracking` can be installed with:

```
conda install drf-api-tracking
```

It is possible to list all of the versions of `drf-api-tracking` available on your platform with:
